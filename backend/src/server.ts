...
const demoWarrantyWorkflows = {
  ...
  workflows: [
    ...
    },
    {
      ...
      summary:
        "Technician scans the removed ADAS sensor, confirms it is the sealed original, and re-fits the same component.",
      expectedSerial: "ADAS-99015-R",
      scannedSerial: "ADAS-99015-R",
...
async function main() {
  ...
  app.get("/api/v1/meta", async () => ({
    ...
    capabilities: [
      ...
      "Removed and fitted part image evidence attachments",
      "Original-part mismatch detection against sealed VIN baseline",
      "Original component re-fit workflow after successful scan verification",
      "Non-genuine and not-logged-to-VIN part capture",
      "Return scanned mismatched part while preserving non-network fitment evidence",
    ...
    suggestedNextBuildSteps: [
      ...
      "Attach image evidence for removed parts, labels, damage, and fitted replacement parts",
      "Choose whether the scanned original is replaced or re-fitted to the same assembly node",
      "Capture non-genuine or unlogged parts even when the scanned item is returned to the vehicle",
